...
const UserPanel = () => {
    ...
    const handleUploadImage = async (e) => {
        ...
        try {
            const uploadImageSnapShot = await firebase.storage()
                .ref()
    ...
    return (
        <div >
            <h3 style={{ display: 'flex', marginBottom: '60px'}}>
                <IoIosChatboxes /> <div style={{ position: "relative", bottom: '3px'}}>Chat App </div>
            </h3>

            <div style={{ display: 'flex',  marginBottom: '1rem' }}>

                <Image src={user && user.photoURL && user.photoURL} style={{ width: '30px', height: '30px' }} roundedCircle />
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item onClick={onHandledImageChange}>프로필 사진 변경</Dropdown.Item>
